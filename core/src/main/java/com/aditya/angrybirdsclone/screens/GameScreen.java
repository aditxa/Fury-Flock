...
public class GameScreen implements Screen {
    ...
    private void setupLevel3() {
        // First tower with steel blocks
        for (int i = 0; i < 2; i++) {
            StoneBlock block = new StoneBlock(500, 57 + i * 78);
            blocks.add(block);
            stage.addActor(block);
        }
        ...
        // Second tower with glass blocks
        for (int i = 0; i < 4; i++) {
        ...
        ArmoredPig pig2 = new ArmoredPig(450, 200);
        pigs.add(pig2);
        stage.addActor(pig2);

        // Third tower with wood blocks
        for (int i = 0; i < 2; i++) {
        ...
        ArmoredPig pig3 = new ArmoredPig(530, 290);
        pigs.add(pig3);
        stage.addActor(pig3);
    }
